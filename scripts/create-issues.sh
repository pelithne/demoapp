...
# Script to create all GitHub issues for the AI Cat vs Dog Voting App
...
gh issue create \
  ...
  --body "Setup initial project structure for full-stack voting application.
...
- Development environment documented" \
  --label "priority:high,type:epic"

# Issue 2: Database Design
gh issue create \
  --title "🗄️ Database Design and Models" \
  --body "Design and implement database schema for images, tournaments, votes, and leaderboards.
...
gh issue create \
  ...
  --body "Build core React components for the voting interface.
...
gh issue create \
  ...
  --body "Develop REST API endpoints for tournament management and voting.
...
gh issue create \
  ...
  --body "Create initial set of AI-generated images and image management system.
...
gh issue create \
  ...
  --body "Implement core tournament bracket and voting logic.
...
gh issue create \
  ...
  --body "Add real-time updates for voting and leaderboards.
...
gh issue create \
  ...
  --body "Create Infrastructure as Code for Azure deployment.
...
- Cost-optimized for low usage" \
  --label "priority:high,type:infrastructure"

# Issue 9: CI/CD Pipeline Setup
gh issue create \
  --title "🚀 CI/CD Pipeline Setup" \
  --body "Create GitHub Actions workflows for CI/CD.
...
- Infrastructure changes deployed automatically" \
  --label "priority:high,type:devops"

# Issue 10: Azure OpenAI Integration
gh issue create \
  --title "🤖 Azure OpenAI Integration" \
  --body "Replace static images with real-time AI image generation.
